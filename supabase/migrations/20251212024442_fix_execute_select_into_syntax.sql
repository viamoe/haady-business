-- ================================
-- Fix EXECUTE SELECT INTO syntax in create_merchant_onboarding
-- ================================
-- Description: Replace EXECUTE FORMAT with direct SELECT INTO statements
--              since we know the table name is 'countries'
-- Date: 2024-12-13
...
-- Recreate the function with direct SELECT INTO (no EXECUTE FORMAT)
