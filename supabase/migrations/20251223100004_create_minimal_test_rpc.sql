-- ================================
-- Create minimal test RPC to isolate timeout issue
-- ================================
-- Description: Creates a simple test function to verify RPC calls work
-- Date: 2025-12-23

-- =====================================================
-- PART 1: Create minimal test function
-- =====================================================

CREATE OR REPLACE FUNCTION public.test_save_personal_details()
RETURNS JSON
LANGUAGE plpgsql
SECURITY DEFINER
STABLE
...
BEGIN
  ...
  -- Just return immediately - no database operations
...
GRANT EXECUTE ON FUNCTION public.test_save_personal_details TO authenticated;
GRANT EXECUTE ON FUNCTION public.test_save_personal_details TO anon;

-- =====================================================
-- PART 2: Create optimized version with minimal operations
-- =====================================================
...
COMMENT ON FUNCTION public.save_personal_details_onboarding IS 'Step 1 of onboarding: Optimized version with minimal operations and better error handling.';
...
BEGIN
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Created test function and optimized RPC';
  RAISE NOTICE '  - test_save_personal_details: Minimal test function';
  RAISE NOTICE '  - save_personal_details_onboarding: Optimized with STABLE marking';
  RAISE NOTICE '  - Better error handling with SQLSTATE';
  RAISE NOTICE '==============================================';
END $$;
