-- ================================
-- Add business_country parameter to create_business_onboarding
-- ================================
-- Description: Updates the function to accept and save business_country (UUID)
--              matching the selected country in the setup form
-- Date: 2025-12-15

-- Drop and recreate the function with business_country parameter
...
DECLARE
  ...
  v_business_country UUID; -- Local variable to avoid ambiguity
BEGIN
  ...
  v_business_country := business_country; -- Store parameter in local variable
  ...
  IF v_existing_profile_id IS NOT NULL THEN
    ...
    SET 
      ...
      business_country = v_business_country, -- Set business_country from selected country ID
...
COMMENT ON FUNCTION public.create_business_onboarding IS 'Creates or updates business profile with business information, including business_country from selected country';

DO $$
BEGIN
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Added business_country parameter to create_business_onboarding';
  RAISE NOTICE 'The selected country ID will now be saved to business_profile.business_country';
  RAISE NOTICE '==============================================';
END $$;
