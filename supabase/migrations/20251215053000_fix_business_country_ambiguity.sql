-- ================================
-- Fix business_country ambiguity in create_business_onboarding
-- ================================
-- Description: Fixes ambiguous column reference by using local variable
-- Date: 2025-12-15

-- Drop and recreate the function with local variable for business_country
...
BEGIN
  ...
  IF v_existing_profile_id IS NOT NULL THEN
    ...
    SET 
      ...
      business_country = v_business_country, -- Use local variable to avoid ambiguity
  ...
  ELSE
    ...
    VALUES (
      ...
      v_business_country, -- Use local variable to avoid ambiguity
      v_preferred_country, 
...
BEGIN
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Fixed business_country ambiguity issue';
  RAISE NOTICE 'Using local variable v_business_country to avoid conflicts';
  RAISE NOTICE '==============================================';
END $$;
