-- ================================
-- Fix countries table reference in create_merchant_onboarding
-- ================================
-- Description: Update the RPC function to use the countries table (not countries_master)
--              The actual table name in the database is 'countries'
-- Date: 2024-12-13
...
-- Recreate the function with dynamic table detection
