-- ================================
-- Fix create_business_onboarding function - remove public.users reference
-- ================================
-- Description: The public.users table doesn't exist, remove references to it
-- Date: 2025-12-15

-- Drop and recreate the function without public.users references
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed create_business_onboarding function - removed public.users references';
END $$;
