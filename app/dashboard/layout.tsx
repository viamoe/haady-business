                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Link
                        href={`/market/${storeId}`}
                        target="_blank"
                        className="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-600 hover:text-[#F4610B] hover:bg-[#F4610B]/5 rounded-lg transition-colors"
                      >
                    ...
                    <TooltipContent side="bottom" sideOffset={8}>
                      Preview your store in Haady Market
                    </TooltipContent>
                  </Tooltip>
                )}
                <Button
